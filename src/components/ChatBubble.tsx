...
const ChatBubble: React.FC = () => {
  ...
  return (
    <>
      {/* Floating Button */}
      <button
        className="fixed z-50 bottom-[50px] right-6 p-0 w-14 h-14 flex items-center justify-center bg-transparent border-none hover:scale-105 transition-transform focus:outline-none"
